...
Source Database       : kd_cs

Target Server Type    : MYSQL
Target Server Version : 50527
File Encoding         : 65001

Date: 2018-04-21 10:32:26
*/
...
-- ----------------------------
-- Table structure for address_bak
-- ----------------------------
...
-- ----------------------------
-- Records of address_bak
-- ----------------------------

-- ----------------------------
-- Table structure for address_copy1
-- ----------------------------
...
-- ----------------------------
-- Table structure for call_record_copy
-- ----------------------------
...
-- ----------------------------
-- Records of call_record_copy
-- ----------------------------

-- ----------------------------
-- Table structure for call_record_in
-- ----------------------------
...
-- ----------------------------
-- Records of call_record_in
-- ----------------------------

-- ----------------------------
-- Table structure for case_apply
-- ----------------------------
...
-- ----------------------------
-- Records of case_apply
-- ----------------------------

-- ----------------------------
-- Table structure for case_apply_copy
-- ----------------------------
...
-- ----------------------------
-- Records of case_apply_copy
-- ----------------------------

-- ----------------------------
-- Table structure for case_apply_copy1
-- ----------------------------
...
-- ----------------------------
-- Records of case_apply_copy1
-- ----------------------------

-- ----------------------------
-- Table structure for case_assign
-- ----------------------------
...
-- ----------------------------
-- Records of case_assign
-- ----------------------------

-- ----------------------------
-- Table structure for case_batch
-- ----------------------------
...
-- ----------------------------
-- Records of case_batch
-- ----------------------------

-- ----------------------------
-- Table structure for case_batch_copy
-- ----------------------------
...
-- ----------------------------
-- Records of case_batch_copy
-- ----------------------------

-- ----------------------------
-- Table structure for case_car_loan
-- ----------------------------
...
-- ----------------------------
-- Records of case_car_loan
-- ----------------------------

-- ----------------------------
-- Table structure for case_collection
-- ----------------------------
...
-- ----------------------------
-- Table structure for case_info_bak
-- ----------------------------
...
-- ----------------------------
-- Records of case_info_bak
-- ----------------------------

-- ----------------------------
-- Table structure for case_info_copy
-- ----------------------------
...
-- ----------------------------
-- Records of case_info_copy
-- ----------------------------

-- ----------------------------
-- Table structure for case_linkman
-- ----------------------------
...
-- ----------------------------
-- Records of case_linkman
-- ----------------------------

-- ----------------------------
-- Table structure for case_paid
-- ----------------------------
...
-- ----------------------------
-- Records of case_paid
-- ----------------------------

-- ----------------------------
-- Table structure for case_paid_1
-- ----------------------------
...
-- ----------------------------
-- Records of case_paid_1
-- ----------------------------

-- ----------------------------
-- Table structure for case_paid_copy
-- ----------------------------
...
-- ----------------------------
-- Records of case_paid_copy
-- ----------------------------

-- ----------------------------
-- Table structure for case_person
-- ----------------------------
...
-- ----------------------------
-- Records of case_person
-- ----------------------------

-- ----------------------------
-- Table structure for case_rate
-- ----------------------------
...
-- ----------------------------
-- Table structure for cno_in_statistics
-- ----------------------------
...
-- ----------------------------
-- Records of cno_in_statistics
-- ----------------------------

-- ----------------------------
-- Table structure for cno_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Table structure for cus_province
-- ----------------------------
...
-- ----------------------------
-- Table structure for entrust_case_product_releation
-- ----------------------------
...
-- ----------------------------
-- Records of entrust_case_product_releation
-- ----------------------------

-- ----------------------------
-- Table structure for entrust_case_source
-- ----------------------------
...
-- ----------------------------
-- Records of entrust_case_source
-- ----------------------------

-- ----------------------------
-- Table structure for entrust_copy
-- ----------------------------
...
-- ----------------------------
-- Records of entrust_copy
-- ----------------------------

-- ----------------------------
-- Table structure for entrust_linkman
-- ----------------------------
...
-- ----------------------------
-- Records of entrust_linkman
-- ----------------------------

-- ----------------------------
-- Table structure for entrust_product
-- ----------------------------
...
-- ----------------------------
-- Records of entrust_product
-- ----------------------------

-- ----------------------------
-- Table structure for entrust_visit
-- ----------------------------
...
-- ----------------------------
-- Table structure for hurry_record
-- ----------------------------
...
-- ----------------------------
-- Records of hurry_record
-- ----------------------------

-- ----------------------------
-- Table structure for last_phone_time
-- ----------------------------
...
-- ----------------------------
-- Records of last_phone_time
-- ----------------------------

-- ----------------------------
-- Table structure for lim_user
-- ----------------------------
...
-- ----------------------------
-- Table structure for message_reminder
-- ----------------------------
...
CREATE TABLE `region` (
  ...
  KEY `name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3356 DEFAULT CHARSET=utf8 COMMENT='案件区域表';
...
-- ----------------------------
-- Table structure for region_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Records of region_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_column_copy
-- ----------------------------
...
CREATE TABLE `sys_organization` (
  ...
  CONSTRAINT `sys_organization_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `sys_organization` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组织机构（部门）';
...
-- ----------------------------
-- Table structure for sys_timer_task
-- ----------------------------
...
-- ----------------------------
-- Records of sys_timer_task
-- ----------------------------

-- ----------------------------
-- Table structure for sys_timer_task_log
-- ----------------------------
...
-- ----------------------------
-- Records of sys_timer_task_log
-- ----------------------------

-- ----------------------------
-- Table structure for sys_user_column_relation
-- ----------------------------
...
-- ----------------------------
-- Records of sys_user_column_relation
-- ----------------------------

-- ----------------------------
-- Table structure for sys_user_resource_relation
-- ----------------------------
...
-- ----------------------------
-- Records of sys_user_resource_relation
-- ----------------------------
...
-- ----------------------------
-- Table structure for target_achieve
-- ----------------------------
...
-- ----------------------------
-- Table structure for timelen_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Records of timelen_out_statistics
-- ----------------------------

-- ----------------------------
-- Table structure for time_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Records of time_out_statistics
-- ----------------------------
...
-- ----------------------------
-- Table structure for visit_record_copy
-- ----------------------------
...
-- ----------------------------
-- Records of visit_record_copy
-- ----------------------------

-- ----------------------------
-- Table structure for visit_template
-- ----------------------------
...
-- ----------------------------
-- Records of visit_template
-- ----------------------------

-- ----------------------------
-- Table structure for visit_template_copy
-- ----------------------------
...
-- ----------------------------
-- Records of visit_template_copy
-- ----------------------------

-- ----------------------------
-- Procedure structure for imp_address
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_address`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_address`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_address_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_address_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_address_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
		insert into address
...
-- ----------------------------
-- Procedure structure for imp_attachment
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_attachment`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_attachment`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_attachment_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_attachment_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_attachment_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_batch
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_batch`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_batch`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_batch_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_batch_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_batch_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case_apply
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_apply`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_apply`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case_apply_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_apply_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_apply_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
		insert into case_apply
...
-- ----------------------------
-- Procedure structure for imp_case_car_loan_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_car_loan_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_car_loan_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case_paid
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_paid`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_paid`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case_paid_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_paid_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_paid_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_case_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_case_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_case_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_comment
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_comment`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_comment`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_comment_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_comment_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_comment_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_employee
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_employee`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_employee`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_hurry_record
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_hurry_record`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_hurry_record`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_hurry_record_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_hurry_record_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_hurry_record_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_linkman_phone
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_linkman_phone`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_linkman_phone`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_linkman_phone_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_linkman_phone_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_linkman_phone_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_organization
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_organization`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_organization`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_phone_record
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_phone_record`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_phone_record`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_phone_record_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_phone_record_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_phone_record_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
		insert into phone_record
...
-- ----------------------------
-- Procedure structure for imp_position
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_position`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_position`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_role
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_role`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_role`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_user_role_relation
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_user_role_relation`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_user_role_relation`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_visit_cus_area
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_visit_cus_area`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_visit_cus_area`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_visit_cus_city
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_visit_cus_city`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_visit_cus_city`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_visit_cus_province
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_visit_cus_province`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_visit_cus_province`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_visit_record
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_visit_record`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_visit_record`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for imp_visit_record_same
-- ----------------------------
DROP PROCEDURE IF EXISTS `imp_visit_record_same`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `imp_visit_record_same`()
BEGIN
		START TRANSACTION;         
		SET AUTOCOMMIT = 0;   
...
-- ----------------------------
-- Procedure structure for proce_split
-- ----------------------------
DROP PROCEDURE IF EXISTS `proce_split`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `proce_split`()
begin  
...
-- ----------------------------
-- Procedure structure for proce_split_final
-- ----------------------------
DROP PROCEDURE IF EXISTS `proce_split_final`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `proce_split_final`()
begin  
	declare cnt int default 0;  
	declare i int default 0;  
	declare str varchar(2000) default '';  
...
-- ----------------------------
-- Procedure structure for up_address
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_address`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_address`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update address a
...
-- ----------------------------
-- Procedure structure for up_batch
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_batch`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_batch`()
BEGIN
...
-- ----------------------------
-- Procedure structure for up_case_area
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_case_area`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_case_area`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
...
-- ----------------------------
-- Procedure structure for up_case_org
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_case_org`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_case_org`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update case_info c 
...
-- ----------------------------
-- Procedure structure for up_case_org_empty
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_case_org_empty`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_case_org_empty`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update case_info c
...
-- ----------------------------
-- Procedure structure for up_case_paid_yj
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_case_paid_yj`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_case_paid_yj`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update case_paid cp
...
-- ----------------------------
-- Procedure structure for up_linkman
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_linkman`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_linkman`()
BEGIN
		DECLARE _cas_id INT;
		DECLARE done INT;
...
-- ----------------------------
-- Procedure structure for up_linkman_address
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_linkman_address`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_linkman_address`()
BEGIN
		DECLARE done INT;
...
-- ----------------------------
-- Procedure structure for up_remark
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_remark`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_remark`()
BEGIN
...
-- ----------------------------
-- Procedure structure for up_visit_area1
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_visit_area1`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_visit_area1`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
...
-- ----------------------------
-- Procedure structure for up_visit_area2
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_visit_area2`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_visit_area2`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update visit_record v   
...
-- ----------------------------
-- Procedure structure for up_visit_area3
-- ----------------------------
DROP PROCEDURE IF EXISTS `up_visit_area3`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `up_visit_area3`()
BEGIN
    START TRANSACTION;         
		SET AUTOCOMMIT = 0;  
		update visit_record v   
...
-- ----------------------------
-- Function structure for calc_length
-- ----------------------------
DROP FUNCTION IF EXISTS `calc_length`;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `calc_length`(str varchar(200), splitstr varchar(5)) RETURNS int(11)
begin 
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `GetNum`(Varstring varchar(50)) RETURNS varchar(30) CHARSET utf8
BEGIN
